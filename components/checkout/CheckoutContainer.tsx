...
const CheckoutContainer = () => {
  ...
  const validateAll = (inputs, isBilling = true) => {
    ...
    if (!isValid) {
      isBilling ? setBillingInputs(newInputs) : setShippingInputs(newInputs);
    }
    ...
    <>
      <SimpleGrid columns={{ base: 1, lg: 2 }} spacing="2rem">
        ...
        <Box border={`1px solid ${brand.gray}`}>
          ...
          >
            <FormControl>
              <FormLabel htmlFor="ordernotes">Order notes (optional)</FormLabel>
              <Textarea
                id="ordernotes"
      ...
      <Heading size="lg" marginX={{ base: "1rem", md: "2rem" }} marginY="1rem">
        Payment
      </Heading>
